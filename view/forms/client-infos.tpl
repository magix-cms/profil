        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                {if $smarty.session.idprofil && $smarty.session.keyuniqid_pr}
                    {capture name="loginRedirect"}<a href="{$hashurl}" title="{#pn_upgrade_profil#}">{#pn_upgrade_profil#}</a>{/capture}
                    <small>{#pn_update_profil#} {$smarty.capture.loginRedirect}</small>
                {/if}
            </div>
        </div>
    </fieldset>
